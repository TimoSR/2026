...
"#;
    ...
    #[test]
    fn rustplus_compiler_facade_compiles_source_text() {
        let source = r#"
class Account
{
    id: String;
...
"#;
        ...
        let generated = compiler.compile_source_text(source).unwrap();

        assert!(generated.code.contains("struct Account"));
        assert!(generated.code.contains("id: String,"));
    }
