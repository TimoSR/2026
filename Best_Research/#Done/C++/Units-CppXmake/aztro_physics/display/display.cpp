...
namespace aztro::physics::length
{
    ...
    export const char* symbol(LengthUnit unit);
    export double value_in_unit(Length value, LengthUnit unit);
    export std::ostream& operator<<(std::ostream& stream, Length value);
...
namespace aztro::physics::velocity
{
    ...
    export const char* symbol(VelocityUnit unit);
    export double value_in_unit(Velocity value, VelocityUnit unit);
    export std::ostream& operator<<(std::ostream& stream, Velocity value);
...
namespace aztro::physics
{
    ...
    export std::ostream& operator<<(std::ostream& stream, QuantityDisplay<length::Length, length::LengthUnit> display);
    export std::ostream& operator<<(std::ostream& stream, QuantityDisplay<time::Time, time::TimeUnit> display);
    export std::ostream& operator<<(std::ostream& stream, QuantityDisplay<mass::Mass, mass::MassUnit> display);
    export std::ostream& operator<<(std::ostream& stream, QuantityDisplay<velocity::Velocity, velocity::VelocityUnit> display);
    export std::ostream& operator<<(std::ostream& stream, QuantityDisplay<acceleration::Acceleration, acceleration::AccelerationUnit> display);
    export std::ostream& operator<<(std::ostream& stream, QuantityDisplay<force::Force, force::ForceUnit> display);
