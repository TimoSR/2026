...
namespace aztro::physics::length
{
    ...
    export Length meters(double value);
    export std::optional<Length> try_meters(double value);
    export Length kilometers(double value);
    export std::optional<Length> try_kilometers(double value);
    export Length centimeters(double value);
    export std::optional<Length> try_centimeters(double value);
    export Length millimeters(double value);
    export std::optional<Length> try_millimeters(double value);
    export Length micrometers(double value);
    export std::optional<Length> try_micrometers(double value);
    export Length nanometers(double value);
    export std::optional<Length> try_nanometers(double value);
...
namespace aztro::physics::length
{
    ...
    export bool operator==(Length left, Length right)
    {
