...
namespace aztro::physics::velocity
{
    ...
    export enum class VelocityUnit
    {
        MetersPerSecond,
        KilometersPerHour,
    };
    ...
    export Velocity meters_per_second(double value);
    export std::optional<Velocity> try_meters_per_second(double value);
    export Velocity meters_pr_second(double value);
    export Velocity kilometers_per_hour(double value);
    export std::optional<Velocity> try_kilometers_per_hour(double value);
...
namespace aztro::physics::velocity
{
    ...
    export bool operator==(Velocity left, Velocity right)
    {
