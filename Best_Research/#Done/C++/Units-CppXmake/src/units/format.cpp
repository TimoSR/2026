...
std::format_context::iterator std::formatter<units::Length, char>::format(units::Length value, std::format_context& context) const
{
    return units::detail::formatQuantityDisplay(context, value.displayAs(units::LengthUnit::Meters));
}

std::format_context::iterator std::formatter<units::Time, char>::format(units::Time value, std::format_context& context) const
{
    return units::detail::formatQuantityDisplay(context, value.displayAs(units::TimeUnit::Seconds));
}

std::format_context::iterator std::formatter<units::Mass, char>::format(units::Mass value, std::format_context& context) const
{
    return units::detail::formatQuantityDisplay(context, value.displayAs(units::MassUnit::Kilograms));
}

std::format_context::iterator std::formatter<units::Velocity, char>::format(units::Velocity value, std::format_context& context) const
{
    return units::detail::formatQuantityDisplay(context, value.displayAs(units::VelocityUnit::MetersPerSecond));
}

std::format_context::iterator std::formatter<units::Acceleration, char>::format(units::Acceleration value, std::format_context& context) const
{
    return units::detail::formatQuantityDisplay(context, value.displayAs(units::AccelerationUnit::MetersPerSecondSquared));
}

std::format_context::iterator std::formatter<units::Force, char>::format(units::Force value, std::format_context& context) const
{
