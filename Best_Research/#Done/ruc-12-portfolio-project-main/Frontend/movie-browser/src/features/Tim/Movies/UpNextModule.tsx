...
const ArtworkPlaceholder = styled.div`
  ...
  border-radius: 12px;
  background:
    radial-gradient(circle at 70% 20%, rgba(125, 211, 252, 0.9), transparent 18%),
    radial-gradient(circle at 28% 72%, rgba(196, 181, 253, 0.75), transparent 24%),
    linear-gradient(145deg, #1e3a8a, #0f172a 70%);
`;
